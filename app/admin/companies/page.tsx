    ...
    <div className="grid gap-4 md:gap-8">
      <Card x-chunk="dashboard-01-chunk-0">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">All Companies</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>john.doe@acme.com</TableCell>
                <TableCell>
              ...
              <TableRow>
                ...
                <TableCell>jane.s@globex.com</TableCell>
                <TableCell>
                  <Badge variant="secondary">Active</Badge>
                </TableCell>
                <TableCell className="text-right">
              ...
              <TableRow>
                ...
                <TableCell>tony.s@stark.com</TableCell>
                <TableCell>
